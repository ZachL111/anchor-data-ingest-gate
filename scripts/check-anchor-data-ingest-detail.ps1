...
$repo = "anchor-data-ingest-gate"
$language = "C++"
$category = "Data engineering"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/anchor-data-ingest-walkthrough.md")) {
