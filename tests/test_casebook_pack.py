"""Regression checks for the anchor-data-ingest-gate casebook."""
...
from casebook.harness import assert_expected, anchor_data_ingest_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(anchor_data_ingest_gate_summary(), assert_expected())
